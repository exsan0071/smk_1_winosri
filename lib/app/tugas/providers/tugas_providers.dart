...
class TugasProvider {
  ...
  // ignore: body_might_complete_normally_nullable
  Future<GetOptions?> getKerjakanTugas(String id) async {
    final _baseUrl =
  ...
  Future addJawaban(String id, String nomor, String jawab) async {
    try {
      SharedPreferences getToken = await SharedPreferences.getInstance();
      // ignore: unused_local_variable
      String? auth = getToken.getString("token");
      ...
      var request = http.MultipartRequest('POST',
          Uri.parse(baseLinkC.baseUrlUrlLaucer3 + "/api/tugas/kerjakan"));
      request.fields.addAll({'idtugas': id, 'nomor': nomor, 'jawab': jawab});
